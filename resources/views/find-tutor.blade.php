                    ...
                    <div class="modal-content bg-blue rounded-modal shadow p-3" style="margin-top: 4rem;">
                        ...
                        <div class="modal-body bg-white top-rounded mt-3">
                            <form  class="mt-3"><center>
                                    <div class="mb-5">
                                        <img src="{{ (isset($getdata)) ? asset($getdata[0]->image) : asset('assets/img/avatar.png') }}" id="profileImage" height="100px" width="100px" class="shadow bg-white rounded-circle" alt="">
                            ...
                            <div class="col-auto col-centered mr-4">
                                <a href="{{ url('Tutor_details',$all->id) }}">
                                    <div class="box-part text-center shadow bg-white tutor-img">
                                        <img src="{{ (isset($all)) ? ((empty($all->image)) ? asset('assets/img/avatar.png') : asset($all->image)) : asset('assets/img/avatar.png') }}" class="img-fluid mx-auto d-block rounded-circle" alt="...">
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-auto col-centered mr-4">
                                <a href="{{ url('Tutor_details',$near->id) }}">
                                    <div class="box-part text-center shadow bg-white tutor-img">
                                        <img src="{{ (isset($nearby)) ? ((empty($near->image)) ? asset('assets/img/avatar.png') : asset($near->image)) : asset('assets/img/avatar.png') }}" class="img-fluid mx-auto d-block rounded-circle" alt="...">
                                        <div class="title mt-1">
                                            <span class="text-dark h5">{{ $name }}</span>
                                        </div>
                                        <div class="mt-1">
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-auto col-centered mr-4">
                                <a href="{{ url('Tutor_details',$pop->iid) }}">
                                    <div class="box-part text-center shadow bg-white tutor-img">
                                        <img src="{{ (isset($popular)) ? ((empty($pop->image)) ? asset('assets/img/avatar.png') : asset($pop->image)) : asset('assets/img/avatar.png') }}" class="img-fluid mx-auto d-block rounded-circle" alt="...">
                                        <div class="title mt-1">
                            ...
                            <div class="col-auto col-centered mr-4">
                                <a href="{{ url('Tutor_details',$tutor->id) }}">
                                    <div class="box-hori shadow bg-white">
                                        <ul class="pl-0 mb-1">
                                            <li class="d-inline-block"><img src="{{ (isset($tutor)) ? ((empty($tutor->image)) ? asset('assets/img/avatar.png') : asset($tutor->image)) : asset('assets/img/avatar.png') }}" class="img-fluid ml-3 d-block rounded-circle" alt="..."></li>
